...
class ReductionsSuite {
  ...
  @Test def `Parallel lineOfSight should correctly handle an array of size 4`: Unit = {
    val output = new Array[Float](12)
    parLineOfSight(Array[Float](0f, 1f, 8f, 9f, 8f, 8f, 8f, 8f, 8f, 8f, 8f, 8f), output, 1)
    assertEquals(List(0f, 1f, 4f, 4f, 4f, 4f, 4f, 4f, 4f, 4f, 4f, 4f), output.toList)
  }
